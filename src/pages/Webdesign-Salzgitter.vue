    ...
    <div id="page" class="site">
      <div id="one" class="mainSection section-one">
        <div class="innerContentContainer head animateBlockHero">
          <BaseTitle :align="'center'" :tag="'h1'" :addClass="'greenColor'" :addStyle="'font-size: 14px; font-weight: 700;'" >WEBDESIGN SALZGITTER</BaseTitle>
          <BaseTitle :align="'center'" :tag="'h2'" :addStyle="'margin: 20px 0px 40px 0px'">Deine Website, perfekt designed für deinen Erfolg in Salzgitter - mit unserem professionellen Webdesign</BaseTitle>
      ...
      <div id="three" class="mainSection section-three">
        <div class="contentContainer">
          ...
          <div>
            <BaseText class="animateBlockText">Willst du eine Website haben, die gut zu deinem Geschäft und deinen Kunden passt? Dann ist unser professioneller Webdesign-Service perfekt für dich. Wir helfen dir von der Planung bis zur Veröffentlichung und arbeiten eng mit dir zusammen, um sicherzustellen, dass die Website genau deinen Wünschen entspricht. Wenn du bereit bist, dein Unternehmen auf die nächste Stufe zu heben und eine großartige Website zu erstellen, dann schreib uns einfach. Wir freuen uns darauf, dir zu helfen und deinen Erfolg zu unterstützen!</BaseText>
          </div>
        </div>
...
export default {
  ...
  data(){
    return {
      ...
      faq: [
        {
          title: "Modernes Webdesign in Salzgitter",
        ...
        },
        {
          ...
          content: "Deine Webseite unterstützt dein Unternehmen schon seit vielen Jahren, aber du merkst, dass sie nicht mehr zeitgemäß ist und dich nicht mehr dabei unterstützt, neue Kunden zu gewinnen? Dann solltest du unbedingt auf den Plan der Greenstein Designagentur setzen. Wir entwickeln unsere Projekte vollkommen responsive und sorgen dafür, dass deine Webseite modern und ansprechend aussieht!\n" +
              "Wir sind überzeugt davon, dass kaum eine andere Webagentur in Salzgitter dir mehr Leistung bei so fairen Konditionen bieten kann wie wir. Deshalb lohnt es sich, mit uns zusammenzuarbeiten, um dein Unternehmen wieder auf die Überholspur zu bringen!",
        },
        {
          title: "SEO-Lösung mit WordPress",
          content: "Wenn du die beste SEO-Lösung mit Content-Management-System aus Salzgitter suchst, dann solltest du unbedingt auf die einzigartige Webseiten-Erstellung durch eine Webagentur Salzgitter setzen, die dir weit mehr als nur die beste Gestaltung bietet. Mit einem integrierten Content-Management-System (CMS), erfolgreicher Werbung und moderner Suchmaschinenoptimierung ist deine Seite für die Zukunft gerüstet.\n" +
              ...
              "Klingt gut, oder? Wir sind überzeugt davon, dass kaum eine andere Webagentur in Salzgitter dir mehr Leistung bei so fairen Konditionen bieten",
        },
        {
          title: "Onlineshop Salzgitter",
          content: " Du bist also auf der Suche nach einer Webagentur, die dich beim Start in den Onlineverkauf unterstützt? Das klingt nach einer tollen Idee - schließlich erreicht man heutzutage mit einem Onlineshop eine viel größere Zielgruppe als mit einem Ladengeschäft.\n" +
              ...
              "Und das Beste: Wir sind nicht nur Profis im Webdesign, sondern kennen uns auch bestens in Salzgitter und Umgebung aus. So können wir dir den perfekten Onlineshop maßschneidern, der genau zu dir und deinem Unternehmen passt.\n" +
              ...
              "Also worauf wartest du noch? Lass uns gemeinsam dein perfektes Webdesign in Salzgitter erschaffen und deinen Onlineshop zum Erfolg führen!",
        },
        {
          title: "Welche Unternehmen in Salzgitter benötigen eine Homepage?",
          content: "heutzutage kommt man nicht mehr um eine ansprechende Webseite herum - das ist einfach das A und O für jedes Unternehmen. Sie steigert nicht nur den Umsatz, sondern macht das Unternehmen auch für potenzielle Kunden zugänglicher und präsenter.\n" +
              ...
              "Wir bieten dir eine Lösung! Seit 2009 sind wir spezialisiert auf Webdesign in Salzgitter. Wir setzen auf WordPress als Content Management System, damit du selbst alles verwalten kannst. Dabei achten wir darauf, dass das Design individuell auf dein Unternehmen abgestimmt ist und die Corporate Identity berücksichtigt wird.\n" +
      ...
      hoverSection: [
        {
          title: "Mehr Kunden",
          icon: "",
          content: "Webdesign ist viel mehr als nur das Aussehen deiner Website. Im Grunde geht es darum, eine innovative und effektive Webseite zu gestalten, die mehr Besucher anzieht. Wenn du mehr Leute auf deine Website bringst, hast du bessere Chancen im Marketing. Deshalb ist gutes Webdesign in Salzgitter so wichtig.",
        },
        {
          title: "Mehr Verkäufe",
          icon: "",
          content: "Eine gut designte Website kann dazu beitragen, dass dein Geschäft erfolgreich wird und als modern und innovativ wahrgenommen wird. Im Internet gibt es viele Tools, mit denen man Websites erstellen kann. Aber Vorsicht: Eine wirklich beeindruckende Website zu erstellen, die deine Kunden begeistert, ist nicht einfach. Dazu gehört mehr als nur ein paar Fotos und Texte. Deine Website muss deine Geschäftsphilosophie und Marketingstrategie widerspiegeln. Wenn du deine Produkte online verkaufen möchtest, musst du sie besonders hervorheben, damit sie den Besuchern sofort ins Auge fallen.",
        },
        {
          title: "Höhere Sichtbarkeit",
          icon: "",
          content: "Deine Webseite muss auch in Suchmaschinen gefunden werden, damit sie erfolgreich ist. Eine Webagentur kann dir dabei helfen, dein Marketing und deinen Verkauf über deine Website anzukurbeln. Als dein Team für Webdesign in Salzgitter bieten wir verschiedene Dienstleistungen an, um dir dabei zu helfen, eine großartige Webseite zu erstellen.",
        },
      ]
    }
  },
