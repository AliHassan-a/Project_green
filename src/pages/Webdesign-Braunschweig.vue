    ...
    <div id="page" class="site">
      <div id="one" class="mainSection section-one">
        <div class="innerContentContainer head animateBlockHero">
          <BaseTitle :align="'center'" :tag="'h1'" :addClass="'greenColor'" :addStyle="'font-size: 14px; font-weight: 700;'" >WEBDESIGN BRAUNSCHWEIG</BaseTitle>
          <BaseTitle :align="'center'" :tag="'h2'" :addStyle="'margin: 20px 0px 40px 0px'">Deine Website, perfekt designed für deinen Erfolg in Braunschweig - mit unserem professionellen Webdesign</BaseTitle>
      ...
      <div id="three" class="mainSection section-three">
        <div class="contentContainer">
          ...
          <div>
            <BaseText class="animateBlockText">Unser Webdesign-Service ist darauf spezialisiert, dir eine professionelle Website zu erstellen, die deine Marke optimal repräsentiert und deine Kunden begeistert. Wir begleiten dich von der Planung bis zur Fertigstellung eng und arbeiten eng mit dir zusammen, um sicherzustellen, dass das Ergebnis deinen Vorstellungen entspricht. Wenn du bereit bist, eine Website zu haben, die deine Kunden begeistert und deinem Unternehmen zum Erfolg verhilft, dann kontaktiere uns für ein kostenloses Erstgespräch. Wir sind gespannt darauf, dich und deinen Erfolg zu Unterstützden!</BaseText>
          </div>
        </div>
...
export default {
  ...
  data(){
    return {
      ...
      faq: [
        {
          title: "Modernes Webdesign in Braunschweig",
        ...
        },
        {
          ...
          content: "Deine Webseite unterstützt dein Unternehmen schon seit vielen Jahren, aber du merkst, dass sie nicht mehr zeitgemäß ist und dich nicht mehr dabei unterstützt, neue Kunden zu gewinnen? Dann solltest du unbedingt auf den Plan der Greenstein Designagentur setzen. Wir entwickeln unsere Projekte vollkommen responsive und sorgen dafür, dass deine Webseite modern und ansprechend aussieht!\n" +
              "Wir sind überzeugt davon, dass kaum eine andere Webagentur in Braunschweig dir mehr Leistung bei so fairen Konditionen bieten kann wie wir. Deshalb lohnt es sich, mit uns zusammenzuarbeiten, um dein Unternehmen wieder auf die Überholspur zu bringen!",
        },
        {
          title: "SEO-Lösung mit WordPress",
          content: "Wenn du die beste SEO-Lösung mit Content-Management-System aus Braunschweig suchst, dann solltest du unbedingt auf die einzigartige Webseiten-Erstellung durch eine Webagentur Braunschweig setzen, die dir weit mehr als nur die beste Gestaltung bietet. Mit einem integrierten Content-Management-System (CMS), erfolgreicher Werbung und moderner Suchmaschinenoptimierung ist deine Seite für die Zukunft gerüstet.\n" +
              ...
              "Klingt gut, oder? Wir sind überzeugt davon, dass kaum eine andere Webagentur in Braunschweig dir mehr Leistung bei so fairen Konditionen bieten",
        },
        {
          title: "Onlineshop Braunschweig",
          content: " Du bist also auf der Suche nach einer Webagentur, die dich beim Start in den Onlineverkauf unterstützt? Das klingt nach einer tollen Idee - schließlich erreicht man heutzutage mit einem Onlineshop eine viel größere Zielgruppe als mit einem Ladengeschäft.\n" +
              ...
              "Und das Beste: Wir sind nicht nur Profis im Webdesign, sondern kennen uns auch bestens in Braunschweig und Umgebung aus. So können wir dir den perfekten Onlineshop maßschneidern, der genau zu dir und deinem Unternehmen passt.\n" +
              ...
              "Also worauf wartest du noch? Lass uns gemeinsam dein perfektes Webdesign in Braunschweig erschaffen und deinen Onlineshop zum Erfolg führen!",
        },
        {
          title: "Welche Unternehmen in Braunschweig benötigen eine Homepage?",
          content: "heutzutage kommt man nicht mehr um eine ansprechende Webseite herum - das ist einfach das A und O für jedes Unternehmen. Sie steigert nicht nur den Umsatz, sondern macht das Unternehmen auch für potenzielle Kunden zugänglicher und präsenter.\n" +
              ...
              "Wir bieten dir eine Lösung! Seit 2009 sind wir spezialisiert auf Webdesign in Braunschweig. Wir setzen auf WordPress als Content Management System, damit du selbst alles verwalten kannst. Dabei achten wir darauf, dass das Design individuell auf dein Unternehmen abgestimmt ist und die Corporate Identity berücksichtigt wird.\n" +
      ...
      hoverSection: [
        {
          title: "Mehr Kunden",
          icon: "",
          content: "Webdesign geht über das simple Aussehen deiner Website hinaus. In Braunschweig kreieren wir einen innovativen und effektiven Internetauftritt für dich, der die Kunden anzieht.Je mehr Interessenten auf deiner Internetpräsenz mitbekommen, desto besser für dein Marketing und desto größer sind deine Chancen auf Erfolg!",
        },
        {
          title: "Mehr Verkäufe",
          icon: "",
          content: "Ein gut durchdachter Internetauftritt kann dazu beitragen, den Verkauf deiner Produkte zu steigern und dein Unternehmen positiv darzustellen. Es gibt im Internet Tools, mit denen man eine Webseite erstellen kann. Allerdings birgt das Erstellen einer Webseite auch Risiken. Denn für eine erfolgreiche Webseite braucht man nicht nur Texte, Bilder oder Videos. Vielmehr sollte die Webseite das Unternehmen und dessen Marketingstrategie entsprechend repräsentieren. Wenn du Produkte verkaufen willst, müssen diese gezielt beworben werden und auf potenzielle Kunden ansprechend wirken.",
        },
        {
          title: "Höhere Sichtbarkeit",
          icon: "",
          content: "Damit deine Webseite im Internet erfolgreich ist, muss sie in den Suchmaschinen gefunden werden. Eine Webagentur kann dir dabei helfen, dein Marketing und Verkauf durch eine professionelle Internetpräsenz zu verbessern. Wir als Webdesign-Team in Braunschweig bieten eine Reihe von Dienstleistungen an, um dir zu einem erfolgreichen Online-Auftritt zu verhelfen.",
        },
      ]
    }
  },
  ...
  metaInfo() {
    return {
      title: "Webdesign Braunschweig",
      meta: [
        { name: 'title', content: "Webdesign Braunschweig" },
        { name: 'description', content: "Webdesign in Braunschweig: Deine Webagentur für Design & Programmierung erfolgreicher Internetseiten. ✓ Bis zu 100% staatliche Förderung." },
        { name: 'og:title', content: "Webdesign Braunschweig" },
        { name: 'og:description', content: "Webdesign in Braunschweig: Deine Webagentur für Design & Programmierung erfolgreicher Internetseiten. ✓ Bis zu 100% staatliche Förderung." },
        { name: 'og:image', content: "https://greenstein.design/Teambesprechung-Greenstein.webp"},
        { name: 'twitter:title', content: "Webdesign Braunschweig" },
        { name: 'twitter:description', content: "Webdesign in Braunschweig: Deine Webagentur für Design & Programmierung erfolgreicher Internetseiten. ✓ Bis zu 100% staatliche Förderung." },
      ],
      script: [
